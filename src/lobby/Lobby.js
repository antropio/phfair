    ...
    render() {
        let lobby_data = {
            info: {
                ...
                copy: 'PREPARATE PARA LO NUEVO DE LA PROPIEDAD\nHORIZONTAL Y DA UN NUEVO PASO HACIA EL FUTURO',
                logo: 'https://firebasestorage.googleapis.com/v0/b/hey-48c29.appspot.com/o/events%2FPRHOPIO_LOGO.png?alt=media&token=55daa421-2b93-4b77-a26c-49ad0f436b4d',
                bgImage: 'https://firebasestorage.googleapis.com/v0/b/hey-48c29.appspot.com/o/events%2FLOBBY_FINAL_FONDO%20(1).png?alt=media&token=0c816125-5f72-4c6a-a158-4a73fa431958',
                bgIntroImage: 'https://firebasestorage.googleapis.com/v0/b/hey-48c29.appspot.com/o/events%2FFONDO_AFUERA_FINAL%20(1).png?alt=media&token=882a5bdd-12ea-4275-a9ab-b5c9505cb24b'
            },
            virtual_events: [
                {
                    name: 'Nombre Evento',
        ...
        return(
          <div className="the-lobby" style={{backgroundImage: `url("${lobby_data.info.bgImage}")`}}>
              <div className={`the-intro ${this.state.showIntro ? 'active' : ''}`} style={{backgroundImage: `url("${lobby_data.info.bgIntroImage}")`}}>
                  <div className="the-intro-access-btn" onClick={this.handleHideIntro}>VIVE LA EXPERIENCIA</div>
              </div>
                  ...
                  <div className="the-lobby-header-col-right">
                      <div className="the-lobby-header-general-info">
                          <div className="the-lobby-header-general-info-wrap">
                              <div className="the-lobby-header-general-info-date">
                      ...
                      <div className="the-lobby-header-copy">
                          <div>{lobby_data.info.copy}</div>
                      </div>
                  </div>
              </div>
              <div className="the-lobby-video">
                  ...
                  <div className="the-lobby-video-wrap">
                      <div className="the-lobby-video-container">
                          <iframe width="560" height="315" src="https://www.youtube.com/embed/RaXVD8dI5Js" frameBorder="0"
                      ...
                      {lobby_data.virtual_events.map((item, id) => (
                          <div className="the-lobby-events-list-item" key={id}>
                              ...
                              <div className="the-lobby-events-list-item-content">
                                  ...
                                  <div className="the-lobby-events-list-item-info">{item.date} {item.hour_from} - {item.hour_to}</div>
                              </div>
                          </div>
                      ))}
                  </div>
